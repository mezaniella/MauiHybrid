using MauiHybrid.Shared.Services;
using MauiHybrid.Web.Components;
using MauiHybrid.Web.Components.Account;
using MauiHybrid.Web.Data;
using MauiHybrid.Web.Services;
...
// Add device-specific services used by the MauiHybrid.Shared project
...
app.MapRazorComponents<App>()
    ...
    .AddAdditionalAssemblies(typeof(MauiHybrid.Shared._Imports).Assembly);
